...
const TITLE_BY_PREFIX: Array<{ prefix: string; title: string }> = [
  ...
  { prefix: "/admin/webhooks", title: "Webhook Endpoints" },
  { prefix: "/admin/webhook-deliveries", title: "Webhook Deliveries" },
  { prefix: "/admin/outbox", title: "Outbox Jobs" },
  { prefix: "/admin/observability", title: "Observability" },
