...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex h-10 items-center justify-center rounded-xl px-5 text-sm font-semibold transition duration-200 disabled:cursor-not-allowed disabled:opacity-50",
