export const ERROR_CODES = {
  ...
  PAYMENT_CORRELATION_NOT_FOUND: "PAYMENT_CORRELATION_NOT_FOUND",
  ...
  REPORTS_INVALID_FILTER: "REPORTS_INVALID_FILTER",
  REPORTS_STORAGE_CONFIG_INVALID: "REPORTS_STORAGE_CONFIG_INVALID",
} as const;
